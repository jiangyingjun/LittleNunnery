...
import com.shuai.R;
import com.shuai.face.util.CameraMatrix;
import com.shuai.face.util.DialogUtil;
import com.shuai.face.util.ICamera;
import com.shuai.face.util.MediaRecorderUtil;
import com.shuai.face.util.OpenGLDrawRect;
import com.shuai.face.util.OpenGLUtil;
import com.shuai.face.util.PointsMatrix;
import com.shuai.face.util.Screen;
import com.shuai.face.util.SensorEventUtil;
                ...
                if (faces != null) {
                    ...
                    if (faces.length >= 0) {
                        ...
                        for (int c = 0; c < faces.length; c++) {
                            ...
                            Log.e("jyj-->","你的年龄是-->"+faces[c].age+"   male--"+faces[c].male+"    女性--"+faces[c].female);
                            Facepp.Face face = faces[c];

                            facepp.getAttribute(face);
                            if (isFaceProperty) {
